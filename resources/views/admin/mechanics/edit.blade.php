...
<div class="form-section">
    ...
    <div class="form-header">
        <div class="header-content">
            ...
            <p class="form-subtitle">Update mechanic profile: {{ $mechanic->name }}</p>
        </div>
    </div>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.mechanics.update', $mechanic->id) }}" method="POST" enctype="multipart/form-data" class="mechanic-form">
            @csrf
            @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="specialization" 
                            ...
                            <option value="Engine" {{ old('specialization', $mechanic->specialization) == 'Engine' ? 'selected' : '' }}>Engine</option>
                            <option value="Brake" {{ old('specialization', $mechanic->specialization) == 'Brake' ? 'selected' : '' }}>Brake Systems</option>
                            <option value="Electrical" {{ old('specialization', $mechanic->specialization) == 'Electrical' ? 'selected' : '' }}>Electrical</option>
                            <option value="Transmission" {{ old('specialization', $mechanic->specialization) == 'Transmission' ? 'selected' : '' }}>Transmission</option>
                            <option value="Suspension" {{ old('specialization', $mechanic->specialization) == 'Suspension' ? 'selected' : '' }}>Suspension</option>
                            <option value="General" {{ old('specialization', $mechanic->specialization) == 'General' ? 'selected' : '' }}>General</option>
                        </select>
                        ...
                        <div class="file-upload-wrapper">
                            ...
                            @if($mechanic->certificate_path)
                                <div class="current-file">
                                    ...
                                    <span>Current: <a href="{{ asset('storage/' . $mechanic->certificate_path) }}" target="_blank">View Certificate</a></span>
                                </div>
                            @endif
                        </div>
