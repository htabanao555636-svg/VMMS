...
<div class="form-section">
    ...
    <div class="form-header">
        <div class="header-content">
            ...
            <p class="form-subtitle">Create a new service offering</p>
        </div>
    </div>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" class="service-form" id="serviceForm">
            @csrf
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}" {{ old('wheeler_category_id') == $category->id ? 'selected' : '' }}>
                                    {{ $category->name }}
                                </option>
                            @endforeach
                        </select>
