...
@section('content')
<section id="category-edit" class="content-section active">
    ...
    <div class="content-box form-container">
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" id="categoryForm">
                ...
                <div class="vehicle-type-options">
                    <label class="radio-label">
                        <input 
                            ...
                            value="3-wheeler" 
                            class="radio-input"
                            {{ old('vehicle_type', $category->vehicle_type) === '3-wheeler' ? 'checked' : '' }}
                        >
                    ...
                    <label class="radio-label">
                        <input 
                            ...
                            value="4-wheeler" 
                            class="radio-input"
                            {{ old('vehicle_type', $category->vehicle_type) === '4-wheeler' ? 'checked' : '' }}
                        >
                        <span class="radio-text">
            ...
            <!-- Category Info -->
            <div class="info-box">
                <p><strong>Created:</strong> {{ $category->created_at->format('M d, Y h:i A') }}</p>
                <p><strong>Last Updated:</strong> {{ $category->updated_at->format('M d, Y h:i A') }}</p>
                <p><strong>Services:</strong> {{ $category->services()->count() }} active</p>
            </div>
